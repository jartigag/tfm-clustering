...
%Ingles
\begin{abstract}
In network monitoring at large scale, knowing how the hosts behave and detecting those who might be suspicious is of high interest.
Nevertheless, classifying each host according to its activity means a major summary exercise.
Besides, it is hard to get useful categories, specially in the case of anomalies, since they are a priori unknown.
The present work addresses this challenge using clustering techniques on firewall logs.
Using a week dataset, 5 classes are distinguished.
One of the clusters, with less than 1\% of the hosts, brings together the anomalous cases.
\par\vspace{0.25cm}
