...
A partir de los datos de sesiones finalizadas descritos anteriormente, se obtiene un dataset en el formato adecuado para aplicar algoritmos de clustering sobre él.
Como se ha comentado, el volumen de datos es muy alto, así que como primera aproximación se extrae una muestra suficientemente grande pero operable a priori.
