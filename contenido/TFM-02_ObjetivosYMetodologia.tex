...
% 1. Extracción vectores de características de las sesiones
% 2. Preprocesado para el clustering:
%       - muestreo
%       - transformación en características: agrupación diaria por IP origen y cálculo de métricas
%       - kmeans con k=5
% 3. Análisis:
%       - revisión manual de las IP origen clasificadas como anomalías
%       - evaluación de la estabilidad del resto de clusters normales, para ver si hay cambios de tendencia
