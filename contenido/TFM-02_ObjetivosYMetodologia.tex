...
De este modo, se desarrollará un sistema que categorice mediante clustering los equipos informáticos finales (es decir, todos menos la infraestructura de la red)
...
Además, se emplearán los indicadores comunes con los que se suele definir la bondad de una técnica de clasificación en aprendizaje automático.
    ...
    \item Detección de anomalías con análisis del clustering
